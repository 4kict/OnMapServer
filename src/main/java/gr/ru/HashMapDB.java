...
public class HashMapDB {
    ...
    public HashMapDB() {
        ...
        add(botBuilder.setCountry("Shri-Lanka").setCity("Bangalor").setLat(10848524).setLon(81078301).setName("bot1-Srialn").build());
        add(botBuilder.setCountry("India").setCity("XZZ").setLat(25261066).setLon(304905461).setName("bot-Eg").build());
        ...
        add(botBuilder.setCountry("Panama").setCity("panama").setLat(8305348).setLon(-78822657).setName("bot3").build());
        ...
        add(botBuilder.setCountry("France").setCity("Pari").setLat(48894386).setLon(2383386).setName("bot1").build());
    }
