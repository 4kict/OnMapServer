    ...
    public void write(final ChannelHandlerContext ctx, final Object msg, final ChannelPromise promise) throws Exception {
        ...
        if (msg instanceof ByteBuf) {
            ...
            if (bf.hasArray()) {
                ...
                //final ChunkedStream chunkedStream = new ChunkedStream(stream, NettyChannelInitializer.MAXFRAMELENGTH - 1024);

                final ChunkedStream chunkedStream = new ChunkedStream(stream, (10 * 1024 * 1024) - 1024);
